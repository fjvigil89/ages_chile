...
//            Pack Lot Lines
            this.pack_lot_lines = [];
            this.pack_lot_lines_by_order_line = {};
	    },
	    add_pack_lot_operation : function(pack_lot_lines){
	        var self = this;
	        this.pack_lot_lines = pack_lot_lines
	        _.each(pack_lot_lines, function(lot_line){
	            self.pack_lot_lines_by_order_line[lot_line.pos_order_line_id[0]] = lot_line
	        });
	    },
	    ...
	    get_brands_search_list: function(){
